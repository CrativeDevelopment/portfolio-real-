...
import sty from "./PlasmicCopyableLink.module.css"; // plasmic-import: CmYzwBVy-6EQR/css
  ...
  return (
    ...
    >
      ...
      <p.PlasmicLink
        ...
        component={Link}
        href={"mailto:lucas@crative.com" as const}
        platform={"nextjs"}
      >
        <div
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: "lucas@crative.net",
            value: args.children,
