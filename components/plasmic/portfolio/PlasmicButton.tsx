...
import projectcss from "../minimalist_about_me_page/plasmic_minimalist_about_me_page.module.css"; // plasmic-import: oJPbG6dAnddYXsmAzBHhSC/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: 8zu6vrMj23k/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 6cGBE7yn7YN/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: w-BOWcKuYgL/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___1Unfn)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__osZtL)}
                role={"img"}
              />
            ),
